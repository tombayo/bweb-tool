...
* Versjon 1.0 av utvidelsen kan også brukes i Firefox: [Bweb-tool for Firefox](https://addons.mozilla.org/en-US/firefox/addon/bweb-tool/).

## Utvikling
* Gjeldende versjon er 1.1.
